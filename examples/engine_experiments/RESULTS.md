...
**Decision-relative certificates (test; `decision_cert`).** A node with wide uncertainty
...
**Coupled criticality and the noise floor (e31; two more readings of the precision form).**
